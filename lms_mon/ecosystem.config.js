const cols = [
  ...Array.from({ length: 25 }, (_, i) => `F10_${String(i + 1).padStart(2, "0")}`),
  ...Array.from({ length: 3 }, (_, i) => `F05_${String(i + 1).padStart(2, "0")}`),
  ...Array.from({ length: 6 }, (_, i) => `F03_${String(i + 1).padStart(2, "0")}`)
];
